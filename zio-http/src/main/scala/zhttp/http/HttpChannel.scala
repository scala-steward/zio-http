...
object HttpChannel extends HttpConstructors with HttpExecutors {
  final case object Identity                                            extends HttpChannel[Any, Nothing, Any, Nothing]
  final case class Succeed[B](b: B)                                     extends HttpChannel[Any, Nothing, Any, B]
  final case class Fail[E](e: E)                                        extends HttpChannel[Any, E, Any, Nothing]
  final case class FromEffectFunction[R, E, A, B](f: A => ZIO[R, E, B]) extends HttpChannel[R, E, A, B]
  final case class Chain[R, E, A, B, C](self: HttpChannel[R, E, A, B], other: HttpChannel[R, E, B, C])
